...
/>
            ...
            <button 
            type="submit" 
            className='col-span-2 text-xl bg-indigo-700 p-2 rounded-full shadow-md text-white my-4 hover:bg-indigo-800'
            >
            Crear Venta
            </button>
        </form>
...
className="col-span-2 bg-indigo-700 p-2 rounded-full shadow-md text-white mx-3 hover:bg-indigo-800 "
>
    Agregar un Producto
    </button>   
</div>
